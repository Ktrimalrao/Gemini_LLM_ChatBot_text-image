...
# installed.
TCL_PREFIX='D:/Data_Science_Masters/Generative AI Project/End_to_End_LLM_prjt/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Data_Science_Masters/Generative AI Project/End_to_End_LLM_prjt/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Data_Science_Masters/Generative AI Project/End_to_End_LLM_prjt/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Data_Science_Masters/Generative AI Project/End_to_End_LLM_prjt/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Data_Science_Masters/Generative AI Project/End_to_End_LLM_prjt/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Data_Science_Masters/Generative AI Project/End_to_End_LLM_prjt/venv\Library\lib\tclstub86.lib'
